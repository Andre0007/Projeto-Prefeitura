...
<html lang="pt-br" ng-app="myApp">   
    ...
    <?php $pagina = 'ListaConcursoEditais'; include './App_Includes/TagSeo.php';?>
        ...
        <main class="ConteudoCentral">
            <div class="container"> 
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12"> 
                        <div class="title_area">
                            <h2 class="title_two">Publicações Concurso Público Editais</h2>
                            <span></span>
                        </div>
                    </div>
                </div>
                ...
                <table id="test-table" class=" sticky-thead">
                    ...
                    <tbody ng-init="getListConcursoEdital()">
                        <tr dir-paginate="poo in listaConcursoEdital| filter:searchText | itemsPerPage:15" pagination-id="prodx">
