<?php
    ...
    $url = "../../View/login-pmm-prefeitura.php";
    ...
    if (empty($email) || empty($senha))
    {
        ...
        $sql = "SELECT id, nome FROM t01_usuario_prefeitura WHERE email = :email AND senha = :senha";
        ...
        if (count($users) <= 0)
        {
            ...
            $_SESSION['PrefeituraLogged_in'] = true;
            $_SESSION['user_id'] = $user['id'];
            $_SESSION['user_nome'] = $user['nome'];
            
            header('Location: ../../View/prefeitura/Dashboard.php');
        }
    }
?>