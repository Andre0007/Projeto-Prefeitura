<?php
    ...
    $url = "../../View/login-pmm-licitacao.php";
    ...
    if (empty($email) || empty($senha))
    {
        ...
        $sql = "SELECT id, nome FROM t09_usuario_licitacao WHERE email = :email AND senha = :senha";
        ...
        if (count($users) <= 0)
        {
            ...
            $_SESSION['LicitacaoLogged_in'] = true;
            $_SESSION['user_id'] = $user['id'];
            $_SESSION['user_nome'] = $user['nome'];

            header('Location: ../../View/licitacao/Dashboard.php');
        }  
    }
?>