<?php
    ...
    if (empty($email) || empty($senha))
    {
        ...
        $sql = "SELECT id, nome FROM t42_usuarios_ouvidoria WHERE email = :email AND senha = :senha AND tipo = 1";
        ...
        if (count($users) <= 0)
        {
            ...
            $_SESSION['CidadaoOuvidoriaLogged_in'] = true;
            $_SESSION['user_id'] = $user['id'];
            $_SESSION['user_nome'] = $user['nome'];
            
            header('Location: ../../View/ouvidoria/CidadaoContribuinte/Home.php');
        }
    }
?>