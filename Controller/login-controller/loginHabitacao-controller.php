<?php
    ...
    $url = "../../View/login-pmm-habitacao.php";
    ...
    if (empty($email) || empty($senha))
    {
        ...
        $sql = "SELECT id, nome, nivel FROM t17_usuario_habitacao WHERE email = :email AND senha = :senha";
        ...
        if (count($users) <= 0)
        {
            ...
            $_SESSION['count_erro'] = 0;
            $_SESSION['HabitacaoLogged_in'] = true;
            $_SESSION['user_id'] = $user['id'];
            $_SESSION['user_nome'] = $user['nome'];
            $_SESSION['nivel'] = $user['nivel'];

            header('Location: ../../View/habitacao/Dashboard.php');
        }  
    }
?>