...
<html lang="pt-br" ng-app="myApp">
    ...
    <?php $titulo = 'Prefeito'; include './App_Includes/Header.php'; ?>  
    ...
    <body ng-controller="ControllerPrefeitura">
        ...
        <section id="PerfilGoverno" ng-init="getListGoverno('Pref')">
                        ...
                        <div class="profile-sidebar">
                            ...
                            <div class="profile-usermenu">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="https://www.facebook.com/antonioaiacyda/?fref=ts" target="_blank">
