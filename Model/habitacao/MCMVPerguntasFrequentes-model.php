...
class McmvPerguntasFrequentes {

    private $conn;
    private $table_name = "t30_mcmv_perguntas_habitacao";
    public $id;
    public $pergunta;
    public $resposta;
    ...
    function readList() {
        $query = "SELECT id, pergunta, resposta, ( select MAX(id) FROM t30_mcmv_perguntas_habitacao ) as UltimoId
                    FROM " . $this->table_name . "
                ORDER BY id DESC";
