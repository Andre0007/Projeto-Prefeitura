...
class Arquivo {
    ...
    private $conn;
    private $table_name = "t06_lista_creche";
    public $id;
    public $nome_titulo;
    public $url;
    ...
    function create() {
        ...
        $query = "INSERT INTO " . $this->table_name . "
                  SET nome_titulo=:nome_titulo, url=:url, data_lancamento=:data_lancamento";
    ...
    function readAll() {
        ...
        $query = "SELECT id, nome_titulo, url, DATE_FORMAT(data_lancamento,'%d/%m/%Y') data_lancamento
    ...
    function readOne() {
        ...
        $query = "SELECT nome_titulo,
                         DATE_FORMAT(data_lancamento,'%d/%m/%Y') data_lancamento
                    FROM " . $this->table_name . "
                   WHERE id = ? 
                   LIMIT 0,1";
