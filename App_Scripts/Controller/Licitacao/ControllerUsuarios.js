...
app.controller('ControllerUsuarios',function($scope, $http, toasty){
    ...
    $scope.updateUsuario = function () {
        $http({
            ...
            url: '../../Controller/Licitacao/usuario-controller/update.php'
    ...
    $scope.readOne = function (id) {
        ...
        $http({
            method: 'POST',
            data: {'id': id},
            url: '../../Controller/Licitacao/usuario-controller/read_one.php'
        }).then(function successCallback(response) {
    ...
    $scope.getAll = function () {
        $http({
            method: 'GET',
            url: '../../Controller/Licitacao/usuario-controller/read.php'
        }).then(function successCallback(response) {
    ...
    $scope.createUsuario = function () {
        $http({
            ...
            url: '../../Controller/Licitacao/usuario-controller/create.php'
        }).then(function successCallback(response) {
            $('#myModal').modal('hide');
            $scope.clearForm();
            $scope.getAll();
    ...
    $scope.deleteUsuario = function (id) {
        if (confirm("Você tem certeza?")) {
            $http({
                method: 'POST',
                data: {'id': id},
                url: '../../Controller/Licitacao/usuario-controller/delete.php'
            }).then(function successCallback(response) {
                $scope.getAll();
            });
            toasty.success({
