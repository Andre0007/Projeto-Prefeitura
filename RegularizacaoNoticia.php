<?php 
    ...
    $pagina = 'RegularizacaoNoticia';   
?>
<!DOCTYPE html>
<html lang="pt-br" ng-app="myApp" ng-controller="ControllerHabitacao">
    <head ng-init="readRegularizacaoArtigo(<?php echo $_GET['id']; ?>)">   
        <?php 
        ...
        <meta property="og:type" content="website">
        <meta property="og:url" content="http://www.mairipora.sp.gov.br/RegularizacaoNoticia.php?id={{id}}">
