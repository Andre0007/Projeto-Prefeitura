...
<html>
    ...
    <?php $titulo = 'Habitação'; include '../App_Includes/administracao/HeaderLogin.php'; ?>

    <body class="backHabitacao">
            ...
            <div class="row" id="pwd-container">
                ...
                <div class="col-md-4">
                    <section class="login-form">
                        ...
                        <form action="../Controller/login-controller/loginHabitacao-controller.php" method="post" role="login">                
