...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MCMHResolucoes'; $titulo = 'Manutenção CMH - Resoluções'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>

    <body ng-controller="ControllerCMHResolucoes">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção CMH - Resoluções</h1>
                                    ...
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in CMHResolucoes | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteCMHResolucoes(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="submit" ng-click="uploadCMHResolucoes(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />

                                                    <input type="submit" ng-click="updateCMHResolucoes(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
