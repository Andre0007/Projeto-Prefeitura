...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MUpload'; $titulo = 'Manutenção Upload Imagens Habitação'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Upload Imagens Habitação</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in FotosHabitacao | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                <td class="text-center">{{ poo.id}}</td>
                                                <td>{{ poo.url}}</td> 
                                                <td>{{ poo.data_upload}}</td> 
                                                <td class="text-center">
                                                    <a ng-click="deleteUpload(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a id="btn-create" class="btn btn-primary" ng-click="uploadImagem(picFile)">Publicar</a>
