...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MSecEquipe'; $titulo = 'Manutenção Secretaria Equipe'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>

    <body ng-controller="ControllerSecretariaEquipeHabitacao">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Secretaria Equipe</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in equipe | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteEquipe(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="cols-sm-10">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" ng-model="nome" id="nome"  placeholder="Digite o Nome do membro da equipe"/>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group">
                                                        ...
                                                        <div class="cols-sm-10">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="fa fa-text-height"></i></span>
                                                                <textarea type="text" class="form-control" ng-model="descricao" rows="5" id="descricao" placeholder="Digite uma breve descrição de você ou do seu trabalho"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>                                                                                                                                                                                              
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="cols-sm-10">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" ng-model="url" id="url" placeholder="Cole a Url da Imagem"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <a id="btn-create" class="btn btn-primary" ng-click="createEquipe()">Publicar</a>

                                                    <a id="btn-update" class="btn btn-warning" ng-click="updateEquipe()">Alterar</a>
