...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MRegularizacaoLegislacao'; $titulo = 'Manutenção Regularização - Legislação'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>

    <body ng-controller="ControllerRegularizacaoLegislacao">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Regularização - Legislação</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in ReguLegislacao | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteRegularizacaoLegislacao(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a id="btn-create" class="btn btn-primary" ng-click="createRegularizacaoLegislacao()">Publicar</a>

                                                    <a id="btn-update" class="btn btn-warning" ng-click="updateRegularizacaoLegislacao()">Alterar</a>
