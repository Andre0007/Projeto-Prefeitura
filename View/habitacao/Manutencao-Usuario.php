<?php
    ...
    $redirect = "../../View/habitacao/Dashboard.php";      
    $_SESSION['nivel'] == 2 ? "" : header("location:$redirect");
    
    require '../../Controller/login-controller/checkHabitacao-controller.php';
?>
<!DOCTYPE html>
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'ManuHabUsuario'; $titulo = 'Manutenção Usuários'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Usuários</h1>
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="cols-sm-2 control-label">Nível</label>
                                                            <div class="cols-sm-10">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                                                    <select class="form-control" name="nivel" id="nivel" ng-model="nivel">
