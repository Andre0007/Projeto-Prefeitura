...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MCMVListaComplementar'; $titulo = 'Manutenção MCMV Lista Complementar'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>

    <body ng-controller="ControllerMCMVListaComplementar">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção MCMV Lista Complementar</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in listaComplementar | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteListaComplementar(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="submit" ng-click="uploadListaComplementar(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />

                                                    <input type="submit" ng-click="updateListaComplementar(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
