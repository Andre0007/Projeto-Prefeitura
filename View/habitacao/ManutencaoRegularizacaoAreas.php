...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MRegularizacaoAreas'; $titulo = 'Manutenção Regularização - Áreas'; include '../../App_Includes/administracao/HabitacaoHeaderManutencao.php'; ?>

    <body ng-controller="ControllerRegularizacaoAreas">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Regularização - Áreas</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in ReguAreas | filter:search | itemsPerPage:15" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteRegularizacaoAreas(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body"> 
                                                    ...
                                                    <div class="form-group">
                                                        <label class="cols-sm-2 control-label">Fase</label>
                                                        <div class="cols-sm-10">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i class="fa fa-text-height"></i></span>
                                                                <input type="text" class="form-control" ng-model="numFase" maxlength="3" id="numFase" placeholder="Digite o número da fase em que está"/>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                ...
                                                <div class="modal-footer">
                                                    <a id="btn-create" class="btn btn-primary" ng-click="createRegularizacaoAreas()">Publicar</a>

                                                    <a id="btn-update" class="btn btn-warning" ng-click="updateRegularizacaoAreas()">Alterar</a>
