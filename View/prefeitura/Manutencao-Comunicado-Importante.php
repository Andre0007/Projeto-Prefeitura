...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MComunicado'; $titulo = 'Manutenção Comunicados Importate'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerComunicadosImportante">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Comunicados Importante</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAll()">
                                            <tr dir-paginate="poo in comunicados | filter:search | itemsPerPage:10" pagination-id="prodx">                                        
                                                ...
                                                <td class="text-center">
                                                    <a ng-click="deleteComunicadosImportante(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="cols-sm-10">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" maxlength="80" ng-model="titulo" id="titulo"  placeholder="Titulo"/>
                                                            </div>
                                                        </div>
                                                    </div>                                                                                                                                                                                                                                            
                                                    <div class="form-group">                                                        
                                                ...
                                                <div class="modal-footer">
                                                    <a id="btn-create" class="btn btn-primary" ng-click="createComunicadosImportante()">Publicar</a>

                                                    <a id="btn-update" class="btn btn-warning" ng-click="updateComunicadosImportante()">Alterar</a>
