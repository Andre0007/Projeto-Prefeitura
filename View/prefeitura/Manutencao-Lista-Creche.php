...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MCreche'; $titulo = 'Manutenção Lista Creche'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerCreche">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Lista Creche</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaCreche | filter:search | itemsPerPage:5" pagination-id="prodx">
                                                    ...
                                                    <td class="text-center">
                                                        <a ng-click="deleteCreche(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form name="form" role="form">                                                   
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="cols-sm-2 control-label">Data Lançamento</label>
                                                                <div class="cols-sm-10">
                                                                    <div class="input-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" ng-click="uploadCreche(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />
                                                            
                                                            <input type="submit" ng-click="updateCreche(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
