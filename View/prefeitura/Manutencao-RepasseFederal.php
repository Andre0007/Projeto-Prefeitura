...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MRepasseFederal'; $titulo = 'Manutenção Lista Repasse Federal'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>

    <body ng-controller="ControllerRepasseFederal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Tabelas de Repasse Federal</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaRepasseFederal | filter:search | itemsPerPage:15" pagination-id="prodx">
                                                    <td class="text-center">{{ poo.id }}</td>
                                                    <td>{{ poo.nome_titulo }}</td>
                                                    <td>{{ poo.data_lancamento }}</td>  
                                                    <td class="text-center">
                                                        <a ng-click="readOne(poo.id)" class="btn btn-warning"><em class="fa fa-pencil"></em></a>                                                              
                                                    </td>
                                                    <td class="text-center">
                                                        <a ng-click="deleteRepasseFederal(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form name="myForm" role="form">                                                   
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="cols-sm-10">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" maxlength="70" ng-model="nome_titulo" id="nome_titulo" placeholder="Titulo do arquivo"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" ng-click="uploadRepasseFederal(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />
                                                            
                                                            <input type="submit" ng-click="updateRepasseFederal(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
