...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MEmail'; $titulo = 'Manutenção e-mails'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>

    <body ng-controller="ControllerEmail">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção E-mails</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in emails | filter:search | itemsPerPage:15" pagination-id="prodx">
                                                    <td>{{ poo.email }}</td>
                                                    <td class="text-center">
                                                        <a ng-click="readOne(poo.id)" class="btn btn-warning"><em class="fa fa-pencil"></em></a>                                                              
                                                    </td> 
                                                    <td class="text-center">
                                                        <a ng-click="deleteEmail(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="cols-sm-10">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" ng-model="email" id="email" maxlength="50" placeholder="Informe o endereço de e-mail"/>
                                                                </div>
                                                            </div>
                                                        </div>                                                                                                                                        
                                                    ...
                                                    <div class="modal-footer">
                                                        <a id="btn-create" class="btn btn-primary" ng-click="createEmail()">Salvar</a>

                                                        <a id="btn-update" class="btn btn-warning" ng-click="updateEmail()">Alterar</a>
