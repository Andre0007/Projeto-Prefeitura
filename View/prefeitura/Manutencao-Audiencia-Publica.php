...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MAudienciaPublica'; $titulo = 'Manutenção Audiencia Pública'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerAudienciaPublica">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Audiência Pública</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaAudienciaPublica | filter:search | itemsPerPage:10" pagination-id="prodx">
                                                    ...
                                                    <td class="text-center">
                                                        <a ng-click="deleteAudienciaPublica(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form name="form" role="form">                                                   
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" ng-click="uploadAudienciaPublica(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />
                                                            
                                                            <input type="submit" ng-click="updateAudienciaPublica(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
