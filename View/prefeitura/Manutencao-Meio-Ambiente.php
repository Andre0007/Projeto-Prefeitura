...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MMeioAmbiente'; $titulo = 'Manutenção Meio Ambiente'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerMeioAmbiente">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Meio Ambiente</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaMeioAmbiente | filter:search | itemsPerPage:15" pagination-id="prodx">
                                                    <td class="text-center">{{ poo.id }}</td>
                                                    <td>{{ poo.nome_titulo }}</td>
                                                    <td>{{ poo.data_postagem }}</td>  
                                                    <td class="text-center">
                                                        <a ng-click="readOne(poo.id)" class="btn btn-warning"><em class="fa fa-pencil"></em></a>                                                              
                                                    </td>
                                                    <td class="text-center">
                                                        <a ng-click="deleteMeioAmbiente(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form name="myForm" role="form">                                                   
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="cols-sm-10">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control" ng-model="nome_titulo" id="nome_titulo" placeholder="Titulo do arquivo"/>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <span class="input-group-btn">
                                                                                ...
                                                                                <div class="btn btn-default image-preview-input" style="border-radius: 0px 4px 4px 0px;">
                                                                                    ...
                                                                                    <input type="file" ngf-select ng-model="picFile" name="file" ngf-max-size="20MB" required="">
                                                                                </div>
                                                                            </span>
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" ng-click="uploadMeioAmbiente(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />
                                                            
                                                            <input type="submit" ng-click="updateMeioAmbiente(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
