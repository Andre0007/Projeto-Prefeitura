...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MConcursoEdital'; $titulo = 'Manutenção Lista Concurso Editais'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerConcursoEdital">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Lista de Concursos para Editais</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaConcursoEditais | filter:search | itemsPerPage:15" pagination-id="prodx">
                                                    ...
                                                    <td class="text-center">
                                                        <a ng-click="deleteConcurso(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form name="myForm" role="form">                                                   
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="submit" ng-click="uploadConcurso(picFile)" id="btn-create" class="btn btn-primary" value="Publicar" />
                                                            
                                                            <input type="submit" ng-click="updateConcurso(picFile)" id="btn-update" class="btn btn-warning" value="Alterar" />
