...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'MConcurso'; $titulo = 'Manutenção Lista Concurso'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerConcursoEstagiario">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12" id="content">
                            ...
                            <h1 class="page-header">Manutenção Lista de Concursos para Estagiários</h1>
                                    ...
                                    <div class="panel-body table-responsive">
                                        <table class="table table-striped table-bordered table-list">
                                            ...
                                            <tbody ng-init="getAll()">
                                                <tr dir-paginate="poo in listaConcurso | filter:search | itemsPerPage:15" pagination-id="prodx">
