...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'Upload'; $titulo = 'Manutenção Upload Imprensa'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção PDF Imprensa</h1>
                            ...
                            <div class="panel panel-primary panel-table">
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAllPdfImprensa()">
                                            <tr dir-paginate="poo in PdfImprensa | filter:search | itemsPerPage:10" pagination-id="prodx">                                        
                                                <td class="text-center">{{ poo.id}}</td>
                                                <td>{{ poo.url}}</td>
                                                <td>{{ poo.data_upload}}</td>
                                                <td class="text-center">
                                                    <a ng-click="deletePdfImprensa(poo.id)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            ...
                                            <form name="myForm" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label class="cols-sm-2 control-label">PDF</label>
                                                ...
                                                <div class="modal-footer">
                                                    <input type="submit" ng-click="submitPdfImprensa(picFile)" class="btn btn-primary" id="submit" value="Publicar" />
