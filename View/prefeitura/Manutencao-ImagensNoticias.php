...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'Upload'; $titulo = 'Manutenção Upload Notícias'; include '../../App_Includes/administracao/PrefeituraHeaderManutencao.php'; ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="main" >
                    <div class="col-sm-12 col-md-12" id="content">
                        ...
                        <h1 class="page-header">Manutenção Imagens Notícias</h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        <tbody ng-init="getAllimgNoticias()">
                                            <tr dir-paginate="poo in ImagNoticias | filter:search | itemsPerPage:10" pagination-id="prodx">                                        
