...
<html lang="pt-br" ng-app="myApp">
    <?php $pagina = 'ManutencaoUploads'; $titulo = 'Manutenção Uploads'; include '../../App_Includes/administracao/LicitacaoHeaderManutencao.php'; ?>
    
    <body ng-controller="ControllerUploadsArquivos">       
        <?php include '../../App_Includes/administracao/LicitacaoMenuManutencao.php'; ?> 
          
        <div class="container">
            <h3 class="page-header">Manutenção Uploads</h3>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-list">
                            ...
                            <tbody ng-init="getAll()">
                                <tr dir-paginate="poo in listaArquivoUp | filter:search | itemsPerPage:15" pagination-id="prodx">
                                    <td class="text-center">{{poo.id_upload}}</td>
                                    <td>{{poo.url_arquivo}}</td>
                                    <td>{{poo.data_upload}}</td>
                                    <td class="text-center">
                                        <a ng-click="deleteUpload(poo.id_upload)" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form name="myForm" role="form">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-btn">
                                                                ...
                                                                <div class="btn btn-default image-preview-input" style="border-radius: 0px 4px 4px 0px;">
                                                                    ...
                                                                    <input type="file" ngf-select ng-model="picFile" name="file" ngf-max-size="11MB" required="">
                                                                </div>
                                                            </span>
                                        ...
                                        <div class="modal-footer">
                                            <input type="submit" ng-click="uploadFiles(picFile)" id="submit" class="btn btn-primary" value="Enviar" />
